...
TYPESCRIPT_MODULES := inventory_service_api model_ts order_service_api
...
.PHONY: typecheck coverage profile benchmark typescript-install typescript-modules-build typescript-build typescript-test \
...
typescript-gen: typescript-install $(TYPESCRIPT_BUF)
	...
	@$(TYPESCRIPT_PROGRESS) "Generate TypeScript module model_ts" \
		$(MAKE) -C ./model_ts generate SKIP_INSTALL=1
