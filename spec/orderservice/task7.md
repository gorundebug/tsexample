...
- Output: `OrderItem` — `model_ts/src/types/order-item.ts`
...
- [ ] Inspect output type `OrderItem` in `model_ts/src/types/order-item.ts`
- [ ] Implement meaningful assertions in `orderservice/test/functions/process-order-items.test.ts`
- [ ] Re-read this checklist
- [ ] Append to `spec/progress.md`: `- [x] orderservice/task7.md — ProcessOrderItems — TypeScript — done`