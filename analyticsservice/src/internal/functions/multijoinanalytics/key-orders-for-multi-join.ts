...
export class KeyOrdersForMultiJoin implements KeyByFunction<AnalyticsEvent, string, AnalyticsEvent> {
...
/** Construct KeyOrdersForMultiJoin asynchronously while the service graph is initialized. */
export async function makeKeyOrdersForMultiJoin(
  context: MessageContext,
  environment: RuntimeEnvironment,
  config: KeyByStreamConfig,
): Promise<KeyOrdersForMultiJoin> {
  void context; void environment; void config;
  return new KeyOrdersForMultiJoin();
}
