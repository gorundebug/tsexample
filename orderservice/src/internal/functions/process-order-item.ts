...
export interface ProcessOrderItemHandlerState {
  orderId: string;
  itemId: string;
  sku: string;
  requestedQty: number;
...
export class ProcessOrderItem implements GrpcSinkEndpointHandler<ProcessOrderItemHandlerState, ProcessOrderItemRequest, ProcessOrderItemResponse, OrderItem, OrderItemResult, OrderState> {
  public beginRequest(context: MessageContext, _stream: SinkStreamContext<OrderItem, OrderItemResult, OrderState>): { readonly context: MessageContext; readonly state: ProcessOrderItemHandlerState } {
    return {
      context,
  ...
  public consumeMessage(context: MessageContext, _stream: SinkStreamContext<OrderItem, OrderItemResult, OrderState>, state: ProcessOrderItemHandlerState, value: Readonly<OrderItem>, sender: GrpcRequestSender<ProcessOrderItemRequest>, _result: GrpcSinkResultContext): Completion {
  ...
  public handleResponse(context: MessageContext, stream: SinkStreamContext<OrderItem, OrderItemResult, OrderState>, state: ProcessOrderItemHandlerState, response: Readonly<ProcessOrderItemResponse>): void | Promise<void> {
  ...
  public endRequest(context: MessageContext, stream: SinkStreamContext<OrderItem, OrderItemResult, OrderState>, error: Error | undefined, state: ProcessOrderItemHandlerState): void | Promise<void> {
