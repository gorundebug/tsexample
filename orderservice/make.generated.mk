...
MODULE_CONTEXT_ARGS =
TSSERVICELIB_SOURCE_CONTEXT ?= https://github.com/gorundebug/tsservicelib.git\#v0.2.71
MODULE_CONTEXT_ARGS += --build-context tsservicelib-source="$(TSSERVICELIB_SOURCE_CONTEXT)"
INVENTORY_SERVICE_API_SOURCE_CONTEXT ?= https://github.com/gorundebug/tsexample.git\#v0.2.71
MODULE_CONTEXT_ARGS += --build-context module-inventory_service_api-source="$(INVENTORY_SERVICE_API_SOURCE_CONTEXT)"
MODEL_TS_SOURCE_CONTEXT ?= https://github.com/gorundebug/tsexample.git\#v0.2.71
MODULE_CONTEXT_ARGS += --build-context module-model_ts-source="$(MODEL_TS_SOURCE_CONTEXT)"
ORDER_SERVICE_API_SOURCE_CONTEXT ?= https://github.com/gorundebug/tsexample.git\#v0.2.71
...
TSSERVICELIB_SOURCE_CONTEXT := $(DEPENDENCY_GIT_MIRROR_DOCKER_BASE)/github.com/gorundebug/tsservicelib.git\#v0.2.71
endif
ifneq ($(strip $(USE_LOCAL_MODULES)),1)
INVENTORY_SERVICE_API_SOURCE_CONTEXT := $(DEPENDENCY_GIT_MIRROR_DOCKER_BASE)/github.com/gorundebug/tsexample.git\#v0.2.71
MODEL_TS_SOURCE_CONTEXT := $(DEPENDENCY_GIT_MIRROR_DOCKER_BASE)/github.com/gorundebug/tsexample.git\#v0.2.71
ORDER_SERVICE_API_SOURCE_CONTEXT := $(DEPENDENCY_GIT_MIRROR_DOCKER_BASE)/github.com/gorundebug/tsexample.git\#v0.2.71
endif
endif
PNPM ?= env CI=true \
